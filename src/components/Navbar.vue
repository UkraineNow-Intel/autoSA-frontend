<template>
  <div class="bg-slate-900 px-5 h-[60px]">
    <div class="max-w-5xl mx-auto flex justify-between items-center h-full">
      ...
      <div>
        <router-link v-if="authStore.isLoggedIn" class="nav-link" :to="{ name: 'home' }">Research</router-link>
        <router-link v-if="authStore.isLoggedIn" class="nav-link" :to="{ name: 'tags' }">Tags</router-link>
